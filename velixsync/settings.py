"""
Django settings for velixsync project.
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='VelixSync <support@velixsync.com>')
ADMIN_NOTIFICATION_EMAIL = config('ADMIN_NOTIFICATION_EMAIL', default='support@velixsync.com')
...
MIDDLEWARE = [
    ...
    'velixsync.middleware.AppendSlashMiddleware',
...
WSGI_APPLICATION = 'velixsync.wsgi.application'
